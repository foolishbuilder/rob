...
def test_check_db_detects_missing_required_columns(monkeypatch: pytest.MonkeyPatch, tmp_path):
    ...
    connection = _FakeConnection(
        build_versions=["001_core_schema", "002_indexes", "003_achievements", "004_sub_send_names", "005_count_recovery", "006_send_change_requests", "007_send_update_requests", "008_notification_modes"],
...
def test_repo_db_build_scripts_include_core_versions():
    ...
    assert "008_notification_modes" in expected
